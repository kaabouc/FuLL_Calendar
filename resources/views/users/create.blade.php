                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="image_user" type="file" class="form-control @error('image_user') is-invalid @enderror" name="image_user" value="{{ old('image_user') }}" required autocomplete="image_user" autofocus>
